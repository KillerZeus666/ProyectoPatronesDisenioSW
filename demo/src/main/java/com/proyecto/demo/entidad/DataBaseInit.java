...
public class DataBaseInit implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Usuario[] usuarios = {
                ...
                new Usuario("Fernando Gutiérrez", 912345678, 3179123456L, "fernando.gutierre@gmail.com", "fernando753",
                        null),
        ...
        Queja[] quejas = {
                new Queja(sdf.parse("2023-10-01"), malServicio, "El agua llega con mal olor y sabor.", servicios[1],
                        empresas[0], usuarios[0]),
                new Queja(sdf.parse("2023-10-02"), malServicio, "El gas no enciende correctamente.", servicios[2],
                        empresas[1], usuarios[1]),
                new Queja(sdf.parse("2023-10-03"), suspensionSinAviso, "Cortes frecuentes de energía.", servicios[4],
