    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        try {
            ...
            if (servicioRepository.count() == 0) {
                // Se asume que las empresas ya existen; se pueden recuperar, por ejemplo, con findAll()
                // Para efectos de ejemplo se crean nuevos objetos referenciales con el id deseado.
            ...
            if (quejaRepository.count() == 0) {
                // Recuperar referencias desde los repositorios (asegúrate de que los IDs usados existen)
                ...
                if (profesionalRepository.count() == 0) {
                        ...
                        log.info("Ya existen " + profesionalRepository.count() + " profesionales en la base de datos. Se omite la inserción.");
                }
